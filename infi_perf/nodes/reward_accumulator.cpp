...
#include "infi_msgs/RewardStamped.h"
#include "infi_msgs/SetRecording.h"
...
private:
	...
	void RewardCallback( const infi_msgs::RewardStamped::ConstPtr& msg )
	{
	...
	bool RecordingCallback( infi_msgs::SetRecording::Request& req,
	                        infi_msgs::SetRecording::Response& res )
	{
